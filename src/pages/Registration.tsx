...
function Registration() {
    ...
    // FORM STEP1
     const step1Inputs: InputProps[] = [
      ...
      const hanldeStep1 = (e: React.FormEvent) => {
        e.preventDefault()
        dispatch(
            setProfileData({
    ...
    useEffect(()=>{
        if(data !== null) {
            ...
            alert(`Não foi possivel realizar a operação. Entre em contato com nosso suporte (${error}).`)
        }
    }, [data, error, navigate])
                    ...
                    <Grid sx={{ flex: 1, display: "flex", alignItems: "center", height: "100vh" }}>
                        <Container maxWidth="sm">
                            ...
                            <Box sx={{marginBottom: pxToRem(24)}}>
                                ...
                                <StyledP>
                                    {''}
                                    {email ? 'Sua senha deve ter: ' 
                                    : 'Pirmeiro diga-nos quem você é.'}
                                </StyledP>
                                {email && ( 
                                    <StyledUl>
                             ...
                             <FormComponent inputs= {handleStepInputs.map((input, index) => ({
                                ...
                                onChange: (e: ChangeEvent<HTMLInputElement>) => email 
                            ...
                            buttons={[
                                {
                                    ...
                                    : !step1FormValid,
                                    onClick: email ? handleStep2 : hanldeStep1,
                                    type:'submit', 
